...
export function DraftRoom({
    ...
    const [selectedDriver, setSelectedDriver] = useState<DriverWithTeam | null>(null);
    ...
    const handleDriverClick = (driver: DriverWithTeam) => {
    ...
    return (
        <>
            ...
            {/* Confirmation Dialog */}
            <AlertDialog open={!!selectedDriver} onOpenChange={(open) => !open && setSelectedDriver(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Confirm Your Pick</AlertDialogTitle>
                        <AlertDialogDescription>
                            You are about to pick <span className="font-semibold text-foreground">{selectedDriver?.first_name} {selectedDriver?.last_name}</span> ({selectedDriver?.team?.name}).
                            <br /><br />
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={confirmPick} disabled={isPending}>
